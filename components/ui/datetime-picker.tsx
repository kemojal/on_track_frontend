...
type DateTimePickerProps = {
  ...
  toDate?: Date;
  /**
   * The number of years to display in the year select
   */
  yearRange?: number;
  /**
  ...
  /**
   * The hour cycle to use (12 or 24)
   */
  hourCycle?: 12 | 24;
  /**
  ...
  (
    ...
    const handleSelect = (date: Date | undefined) => {
      ...
      if (selectedDate) {
        ...
        // Set default time to current time if no previous time
        const newDate = new Date(date);
        const now = new Date();
    ...
    // Create a date validator function that combines component disabled state and date range validation
